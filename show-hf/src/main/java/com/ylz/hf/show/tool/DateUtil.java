...
public class DateUtil {
    ...
    public static final String DATE_TIME_FORMAT_HHMMSS = "HHmmss";
    ...
    public static final String DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI_SS_SS = "yyyy-MM-dd HH:mm:ss.s";
    ...
    public static final String DATE_FORMAT_YYYYMMDD_HHMI = "yyyyMMdd-HHmm";


    public static final String DATE_TIME_FORMAT_YYYY_MM_DDHH_MI_SS_SS = "yyyy-MM-ddHH:mm:ss";//2019-02-1409:04:11
    ...
    public static Date strToDate(String strTime) {
        ...
        list.add(DATE_FORMAT_YYYYMMDD_HHMI);
        list.add(DATE_TIME_FORMAT_YYYY_MM_DD_HH_MI_SS_SS);
        list.add(DATE_TIME_FORMAT_YYYY_MM_DDHH_MI_SS_SS);
     ...
     * @return
     */
    public static Date strToDate2(String strTime) {
        if (strTime == null || strTime.trim().length() <= 0)
            return null;
        ...
        list.add(DATE_TIME_FORMAT_YYYYMMDDHHMISS);
        list.add(DATE_FORMAT_YYYYMMDDHHmm);
        list.add(DATE_FORMAT_YYYYMMDD);
        list.add(DATE_TIME_FORMAT_HHMMSS);
