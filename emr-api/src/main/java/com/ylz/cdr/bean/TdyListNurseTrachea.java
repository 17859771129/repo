...
@Data
@TableName("TDY_LIST_NURSE_TRACHEA")
public class TdyListNurseTrachea implements Serializable {

    private static final long serialVersionUID = 3953670498295967254L;
    private Integer pk;
