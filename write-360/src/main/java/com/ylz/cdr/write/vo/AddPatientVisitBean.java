...
public class AddPatientVisitBean {
    ...
    private String patientGlobaleId;
    ...
    public String getPatientGlobaleId() {
        return patientGlobaleId;
    }

    public void setPatientGlobaleId(String patientGlobaleId) {
        this.patientGlobaleId = patientGlobaleId;
    }
